      ...
      <div class="content">
        ...
        <div style="margin-top: 80px; text-align: center; border-top: 1px solid var(--card-border); padding-top: 40px;">
          ...
          <div style="display: flex; justify-content: center; gap: 24px; flex-wrap: wrap;">
            ...
            <a href="https://github.com/10deepak10/zero-ui" target="_blank" style="display: flex; align-items: center; gap: 8px; color: var(--text-main); text-decoration: none; padding: 8px 16px; border: 1px solid var(--card-border); border-radius: 8px; background: var(--card-bg); transition: all 0.2s;">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
